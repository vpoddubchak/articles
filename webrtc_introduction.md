...
![History](pictures/webrtc_history2.png)
...
Появившись на свет, WebRTC должен был быть лучше существующих решений для видео-звонков, давайте сравним его с главным конкурентом - SIP.

![WebRTCvsSIP](pictures/SIP_vs_WebRTC_table.png)

Как видим, с технической стороны особой разницы нету, отличия заключаются в другой плоскости:
...
3. Ставка на веб-разработчкиов: простой API и поддержка в набиравшем популярность Chrome. 
...
Но WebRTC - это не только браузер. На сегодняшний день мы можем использовать эту технологию на любой платформе где можно скомпилировать С++ код. Ведь в основе лежат всё те же RTP для медиа данных и WebSocket (в большинстве случаев) для сигналинга. 

#### Основные компоненты WebRTC

![javascriptapi](pictures/webrc_js_api.png)

На поверхности лежит JavaScript API. Она состоит оз 3 основных модулей:
...
![webrtc_test](pictures/apprtc.png)
...
![signaling_server](pictures/Signaling.png)
...
![offer-answer](pictures/Offer_Answer.png)
...
[4] https://hpbn.co/webrtc

[4] https://webrtchacks.com/sdp-anatomy/

[5] https://tools.ietf.org/id/draft-ietf-ice-rfc5245bis-14.html

[6] https://www.callstats.io/blog/2018/05/11/history-of-webrtc-infographic

[7] https://www.pubnub.com/blog/2014-10-21-building-a-webrtc-video-and-voice-chat-application/
